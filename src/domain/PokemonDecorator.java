...
/**
 * Clase decorador abstracta para Pokémon.
 * Mantiene una referencia al objeto PokemonBase que está decorando.
 */
public abstract class PokemonDecorator implements PokemonBase {
    ...
    public int getPhysicalAttack() { 
        return pokemon.getPhysicalAttack(); 
    }
    ...
    public int getPhysicalDefense() { 
        return pokemon.getPhysicalDefense(); 
    }
    
    @Override
    public int getStatus() { 
        return pokemon.getStatus(); 
    }
    
    @Override
    public int getTurnStatus() { 
        return pokemon.getTurnStatus(); 
    }
    ...
    public void setPhysicalAttack(int physicalAttack) { 
        pokemon.setPhysicalAttack(physicalAttack); 
    }
    
    @Override
    public void setPhysicalDefense(int physicalDefense) { 
        pokemon.setPhysicalDefense(physicalDefense); 
    }
    ...
    public void setTurnStatus(int turnStatus) { 
        pokemon.setTurnStatus(turnStatus); 
    }
    ...
    public List<String> getNombreAtaques() { 
        return pokemon.getNombreAtaques(); 
    }
    ...
    public boolean hasStatus(int statusCode) {
        return pokemon.hasStatus(statusCode);
    }
}